	...
	<div class="container">
		<form name="newMember" class="form-horizontal"
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="mid" type="text" class="form-control" placeholder="id" value="<c:out value='${row.mid }'/>" >
				</div>
			</div>
			<div class="form-group  row">
			...
			<div class="form-group  row">
				<div class="col-sm-offset-2 col-sm-10 ">
					...
					<a href="deleteMember.jsp" class="btn btn-dark">회원탈퇴</a>
				</div>
			</div>
		</form>	
...
<script type="text/javascript">
	...
	function checkForm() {
		if (!document.newMember.mid.value) {
			alert("아이디를 입력하세요.");
			return false;
		}
